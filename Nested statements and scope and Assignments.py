...
# Check wether a staring is a Panagram or not
# Panagram is a scentence containing every letter of alphabet from a to z

import string


def check_panagram(str1, alphabet=string.ascii_lowercase):
    for i in str1:
